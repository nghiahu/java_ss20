...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, Long> SpecializedFilter = students.stream().collect(Collectors.groupingBy(Student::getMajor, Collectors.counting()));
        SpecializedFilter.entrySet().stream().sorted((a,b) -> Long.compare(b.getValue(), a.getValue())).forEach(entry -> {
